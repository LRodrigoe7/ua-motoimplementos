    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">UA Motoimplementos</p>
        </div>
        ...
        <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              El presupuesto presentado por el taller tiene una vigencia de <strong>7 días corridos</strong> desde su
          ...
          <section>
            ...
            <p>
              ...
              los <strong>10 días corridos</strong> siguientes a dicha notificación.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              Si el cliente rechaza el presupuesto, deberá retirar el equipo dentro de los <strong>10 días corridos</strong>{' '}
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-xs text-gray-400 text-center">
          UA Motoimplementos · Última actualización: junio 2026
        </div>
